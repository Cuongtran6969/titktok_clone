...
import { faArrowRightFromBracket, faBookmark, faCircleQuestion, faCircleXmark, faEarthAmericas, faEllipsisVertical, faGear, faKeyboard, faMagnifyingGlass, faMoon, faPlus, faUser, faVideo } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <header className={cx('wrapper')}>
            ...
            <div className={cx('header-nav')}>
                {currentUser ?
                    (<>
                        ...
                        <div className={cx('message-container')}>
                            <Tippy
                                ...
                                <Link to="/upload" className={cx('message-direct_btn')}>
                                    <div>
                                        <FontAwesomeIcon icon={faPaperPlane} className={cx('action-icon')} />
                                    </div>
                                </Link>
                            </Tippy>
                        </div>
                        <div className={cx('inbox-container')}>
                            ...
                            >
                                <div>
                                    <FontAwesomeIcon icon={faMessage} className={cx('action-icon')} />
                                </div>
                            </Tippy>
                        </div>
                    </>) :
                ...
                <Menu items={currentUser ? userMenu : MENU_ITEMS} onChange={handleOnchage}>
                    {currentUser ?
                        (
                            <div className={cx('menu_image')}>
                                <img className={cx('avatar')} src="https://scontent.fhan15-2.fna.fbcdn.net/v/t39.30808-1/425505041_951096166584109_1070111714873098817_n.jpg?stp=cp6_dst-jpg_p200x200&_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_ohc=tlE-8fyBNtkQ7kNvgFYuZZ8&_nc_ht=scontent.fhan15-2.fna&oh=00_AfCWYVcXK0PuHayD5JGxUyhV3xhXX50HDYUcM1BKny2NMg&oe=663FB1DF" alt="" />
                            </div>
                        ) :
                        (
